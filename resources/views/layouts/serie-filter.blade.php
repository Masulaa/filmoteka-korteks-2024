        ...
        <div class="p-8 bg-white shadow-lg dark:bg-gray-800 rounded-xl filter-container">
            ...
            <div class="max-w-full mx-auto mb-6">
                ...
                <div class="range">
                    ...
                    <div class="relative range-input">
                        <input type="range" class="min" name="min_year" min="1900" max="{{ date('Y') }}" value="1900"
                            step="1">
                    ...
                    <div class="range-price">
                        <div class="field">
                            ...
                            <input type="number" name="min_year_display" value="1900" min="1900" max="{{ date('Y') }}"
                        ...
                        <div class="field">
                            ...
                            <input type="number" name="max_year_display" value="{{ date('Y') }}" min="1900"
                                max="{{ date('Y') }}" class="text-gray-900 bg-white dark:bg-gray-700 dark:text-white">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-6 genre-select">
                ...
                <select name="genre"
                    ...
                    <option value="Action & Adventure" {{ request('genre') == 'Action & Adventure' ? 'selected' : '' }}>
                    ...
                    <option value="Documentary" {{ request('genre') == 'Documentary' ? 'selected' : '' }}>Documentary
                    </option>
                    ...
                    <option value="Sci-Fi & Fantasy" {{ request('genre') == 'Sci-Fi & Fantasy' ? 'selected' : '' }}>Sci-Fi
                        & Fantasy</option>
                    <option value="Soap" {{ request('genre') == 'Soap' ? 'selected' : '' }}>Soap</option>
                    <option value="Talk" {{ request('genre') == 'Talk' ? 'selected' : '' }}>Talk</option>
                    <option value="War & Politics" {{ request('genre') == 'War & Politics' ? 'selected' : '' }}>War &
                        Politics</option>
                    <option value="Western" {{ request('genre') == 'Western' ? 'selected' : '' }}>Western</option>
                </select>
            </div>

            <div class="mb-6">
                <label for="most_viewed" class="flex items-center text-sm font-medium text-white/90">
                    <input type="checkbox" id="most_viewed" name="most_viewed"
                        class="mr-2 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ request('most_viewed') ? 'checked' : '' }}>
            ...
            <div class="mb-6">
                <label for="highest_rated" class="flex items-center text-sm font-medium text-white/90">
                    <input type="checkbox" id="highest_rated" name="highest_rated"
                        class="mr-2 rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ request('highest_rated') ? 'checked' : '' }}>
