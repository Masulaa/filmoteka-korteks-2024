...
@section('content')
    <div class="py-24 dark-white sm:py-32">
        <div class="grid px-6 mx-auto max-w-7xl gap-x-8 gap-y-20 lg:px-8 xl:grid-cols-3">
            ...
            <ul role="list" class="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="w-16 h-16 rounded-full" src="https://avatars.githubusercontent.com/u/69390868?v=4"
                            alt="">
                        <div>
                ...
                <li>
                    <div class="flex items-center gap-x-6">
                        <img class="w-16 h-16 rounded-full" src="https://avatars.githubusercontent.com/u/171392164?v=4"
                            alt="">
                        <div>
