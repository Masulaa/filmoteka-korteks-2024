...
<script>
    alert("Ово су dummy странице узете од movie blade-ова.\nДок се база не направи како треба не служе ничему.");
</script>
                                ...
                                <div class="relative aspect-w-2 aspect-h-3">
                                    ...
                                    <div
                                        ...
                                        <button
                                            ...
                                            data-user-id="{{ auth()->id() }}" data-serie-id="{{ $serie->id }}">
                                            Add to Favorites
                                        </button>
                                    </div>
                                </div>
                                <div class="px-4 py-3 mt-2">
                                    ...
                                    <div class="flex items-center mt-3">
                                        ...
                                        <p class="ml-1 text-sm text-gray-600 dark:text-gray-400">
                                            {{ $serie->averageRating() }} ({{ $serie->countRatings() }} ratings)</p>
                                    </div>
                                    <div class="flex items-center mt-3">
                                    <svg class="flex-shrink-0 w-5 h-5 text-white" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        <p class="ml-1 text-sm text-gray-600 dark:text-gray-400">Views: {{ $serie->views }}</p>
                                    </div>
